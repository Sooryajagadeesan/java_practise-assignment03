...
public class PerimeterOfRectangle {
    public static void main(String[] args) {
        ...
        float perimeterOfRectangle = calculateRectanglePerimeter(length, breadth);
        System.out.println("Perimeter of the rectangle with length(in cms.): " + length + " cms. and breadth(in cms.): " + breadth + " cms. is " + perimeterOfRectangle + " cms.");
    }
     ...
     */
    static float calculateRectanglePerimeter(float length, float breadth) {
